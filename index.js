...
function crearList(colorElement, i) {
  ...
  const backgroundColor = document.createElement("button");
  ...
  //Añade color de muestra
  div.style.backgroundColor = colorElement.hex;

  //Saca alerta con el nombre del color
  item.addEventListener("click", e => {
    e.stopPropagation();
    alert(colorElement.colorName);
  });

  // Cambia color del siguiente elemento
  ...
  // Cambia color del fondo de la pagina
